...
<html class="no-js" lang="en">
  <head>
    ...
    <meta name="robots" content="<?php echo $this->config->item('app_robots_ui_admin'); ?>"/>
    <meta name="googlebot" content="<?php echo $this->config->item('app_googlebot_ui_admin'); ?>"/>
    <meta name="google-site-verification" content="<?php echo $this->config->item('app_google-site-verification_ui_admin'); ?>"/>
    <meta name="author" content='<?php echo $this->config->item('app_author_ui_admin'); ?>' />
    <meta name="keywords" content="<?php echo "" . $keywords; ?>, <?php echo $this->config->item('app_keywords_ui_admin'); ?>" />
    <meta name="description" content="<?php echo "" . $description; ?> <?php echo $this->config->item('app_description_ui_admin'); ?>" />
    <meta name="revisit-after" content="<?php echo $this->config->item('app_revisit-after_ui_admin'); ?>" />
    <meta http-equiv="content-language" content="<?php echo $this->config->item('app_content-language_ui_admin'); ?>" />
    <meta name="distribution" content="<?php echo $this->config->item('app_distribution_ui_admin'); ?>" />
    <meta http-equiv="content-type" content="<?php echo $this->config->item('app_content-type_ui_admin'); ?>" />
    <?php // canonical seo ?>
