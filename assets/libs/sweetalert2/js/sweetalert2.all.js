!function(t, e) {
    ...
    function rt(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e
          , o = q();
        mt(o) && (n && (o.style.transition = "none",
        o.style.width = "100%"),
        setTimeout(function() {
    ...
    var lt, dt = function(t, e) {
        ...
        var e, n = !!(e = K()) && (e.parentNode.removeChild(e),
        pt([document.documentElement, document.body], [z["no-backdrop"], z["toast-shown"], z["has-column"]]),
        !0);
        if (at())
            v("SweetAlert2 requires document to initialize");
        else {
            var o = document.createElement("div");
            o.className = z.container,
            n && dt(o, z["no-transition"]),
            V(o, ht);
    ...
    function wt(t, e, n) {
        var o;
        nt(t, n["show".concat((o = e).charAt(0).toUpperCase() + o.slice(1), "Button")], "inline-block"),
    ...
    function Ct(t, e) {
        ...
        if (n) {
            var o, i, r, a;
            o = n,
            "string" == typeof (i = e.backdrop) ? o.style.background = i : i || dt([document.documentElement, document.body], z["no-backdrop"]),
            !e.backdrop && e.allowOutsideClick && N('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
            r = n,
            (a = e.position)in z ? dt(r, z[a]) : (N('The "position" parameter is not valid, defaulting to "center"'),
            dt(r, z.center)),
            function(t, e) {
            ...
            c && (n.setAttribute("data-queue-step", c),
    ...
    Ot.text = Ot.email = Ot.password = Ot.number = Ot.tel = Ot.url = function(t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : b(e.inputValue) || N('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
        kt(t, e),
        t.type = e.input,
        t
    }
    ...
    function Tt(t, e) {
        ...
        e.html ? (st(e.html, c),
        tt(c, "block")) : e.text ? (c.textContent = e.text,
        tt(c, "block")) : et(c),
        n = t,
        o = e,
        i = x(),
    ...
    var Vt = function() {
      ...
      , Rt = function() {
        for (var t = Y(), e = window.getComputedStyle(t).getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++)
      ...
      , Nt = []
      , Ut = function(t, e) {
        t.className = "".concat(z.popup, " ").concat(mt(t) ? e.showClass.popup : ""),
        e.toast ? (dt([document.documentElement, document.body], z["toast-shown"]),
        dt(t, z.toast)) : dt(t, z.modal),
        H(t, e, "popup"),
      ...
      , Gt = Object.freeze({
        ...
        queue: function(t) {
            ...
            return new Promise(function(i) {
                !function e(n, o) {
                    n < Nt.length ? (document.body.setAttribute("data-swal2-queue-step", n),
    ...
    function te() {
        ...
        if (t) {
            ...
            t.showConfirmButton || (et(e.confirmButton),
            t.showCancelButton || et(e.actions)),
    ...
    function ee() {
        ...
        document.body.style.paddingRight = "".concat(Q.previousBodyPadding + function() {
            var t = document.createElement("div");
    ...
    function ce(t, e, n, o) {
        ...
        "undefined" != typeof window && ne() && window.removeEventListener("resize", oe),
    ...
    function ge(t) {
        ...
        Z() || Zt.previousActiveElement || (Zt.previousActiveElement = document.activeElement),
    ...
    function Pe(t, e, n) {
        xt.innerParams.get(t).toast ? ze(t, e, n) : (Ke(e),
        Ye(e),
        Ze(t, e, n))
    }
    var Ae = function(t, e) {
        yt && it(e) ? (t.style.overflowY = "hidden",
        e.addEventListener(yt, ve)) : t.style.overflowY = "auto"
    }
      , Be = function(t, e) {
        !function() {
      ...
      , Se = function(t, e, n) {
        ...
        n.heightAuto && n.backdrop && !n.toast && dt([document.documentElement, document.body], z["height-auto"])
    }
      , Ee = function(t) {
      ...
      , Me = function(e, n) {
        ...
        })) : e.getInput().checkValidity() ? Ve(e, n, o) : (e.enableButtons(),
        e.showValidationMessage(n.validationMessage))
    }
      , Ve = function(e, t, n) {
        (t.showLoaderOnConfirm && _t(),
      ...
      , De = function(t, e, n) {
        ...
        "Enter" === e.key ? Ne(t, e, o) : "Tab" === e.key ? Ue(e, o) : -1 !== Re.indexOf(e.key) ? _e() : -1 !== He.indexOf(e.key) && Fe(e, o, n)
    }
      , Ne = function(t, e, n) {
      ...
      , Fe = function(t, e, n) {
        _(e.allowEscapeKey) && (t.preventDefault(),
        n(F.esc))
    }
      , ze = function(e, t, n) {
    ...
    var Qe = function(t, e, n) {
        var o = q();
        et(o),
        e.timer && (t.timeout = new fe(function() {
            n("timer"),
            delete t.timeout
        }
        ,e.timer),
        e.timerProgressBar && (tt(o),
        setTimeout(function() {
      ...
      , $e = function(t, e) {
        if (!e.toast)
            return _(e.allowEnterKey) ? e.focusCancel && mt(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && mt(t.confirmButton) ? t.confirmButton.focus() : void xe(0, -1, 1) : Je()
    }
      , Je = function() {
    ...
    var Xe, Ge = function(t) {
        ...
        _main: function(t) {
            !function(t) {
                for (var e in t)
                    ...
                    t.toast && (o = e,
                    -1 !== Xt.indexOf(o) && N('The parameter "'.concat(o, '" is incompatible with toasts'))),
                    Yt(n = e) && g(n, Yt(n));
                var n, o, i
            }(t),
        ...
        _destroy: function() {
            ...
            e && (t.popup && Zt.swalCloseEventFinishedCallback && (Zt.swalCloseEventFinishedCallback(),
            delete Zt.swalCloseEventFinishedCallback),
    ...
    Object.keys(tn).forEach(function(t) {
        en[t] = function() {
            if (Xe)
                return Xe[t].apply(Xe, arguments)
        }
    }),
    en.DismissReason = F,
    en.version = "9.10.12";
