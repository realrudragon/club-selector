    ...
    Lobibox.base.OPTIONS = {
        ...
        icons: {
            ...
            fontAwesome: {
                ...
                success: 'mdi mdi-check-all',
                error: 'mdi mdi-close',
                warning: 'mdi mdi-information-outline',
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        // soundPath: $('meta[name^=vendorUrl]').attr('content')  + '/lobibox/sounds/',   // The folder path where sounds are located
        soundPath: $('meta[name^=libsUrl]').attr('content')  + '/lobibox/sounds/',   // The folder path where sounds are located
