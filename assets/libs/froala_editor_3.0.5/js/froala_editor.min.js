...
!function(e, t) {
    ...
    H.MODULES.node = function(a) {
        ...
        return {
            ...
            deepestParent: function i(e, t, n) {
                ...
                void 0 === n && (n = !0),
                t.push(a.el),
                0 <= t.indexOf(e.parentNode) || e.parentNode && a.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= H.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n)
                    return null;
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !a.node.hasClass(e.parentNode, "fr-inner") && (H.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || l(e.parentNode)) && (!l(e) || !l(e.parentNode) || !n); )
                    e = e.parentNode;
                return e
            },
            rawAttributes: c,
    ...
    H.MODULES.clean = function(f) {
        ...
        function S(e) {
            ...
            !function c(e) {
                ...
                e.nodeType === Node.ELEMENT_NODE && (e.getAttribute("data-fr-src") && 0 !== e.getAttribute("data-fr-src").indexOf("blob:") && e.setAttribute("data-fr-src", f.helpers.sanitizeURL(E(e.getAttribute("data-fr-src")))),
                ...
                if (f.opts.htmlAllowComments || e.nodeType !== Node.COMMENT_NODE)
                    if (e.tagName && e.tagName.match(p))
                        ...
                        "svg" === e.tagName ? e.parentNode.removeChild(e) : f.browser.safari && "path" === e.tagName && e.parentNode && "svg" === e.parentNode.tagName || (e.outerHTML = e.innerHTML);
                    else {
                        var r = e.attributes;
                        if (r)
                            for (var o = r.length - 1; 0 <= o; o--) {
                                var i = r[o]
                                  ...
                                  , s = null;
                                "style" === i.nodeName && f.opts.htmlAllowedStyleProps.length && (s = i.value.match(h)),
                                a && s ? i.value = m(s.join(";")) : a && ("style" !== i.nodeName || s) || e.removeAttribute(i.nodeName)
                            }
                    }
                else
            ...
            toHTML5: function r() {
                ...
                if (e.length) {
                    ...
                    for (var n = 0; n < e.length; n++)
                        "" === f.node.attributes(e[n]) && g(e[n]).replaceWith("<".concat(H.HTML5Map[e[n].tagName], ">").concat(e[n].innerHTML, "</").concat(H.HTML5Map[e[n].tagName], ">"));
    ...
    H.MD = 2,
    H.LG = 3;
    H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"),
    H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())",
    H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"),
    H.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(H.LinkRegExCommon, ")"),
    H.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"),
    H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"),
    H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd),
    H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"],
    H.MAIL_REGEX = /.+@.+\..+/i,
    H.MODULES.helpers = function(i) {
        var a, s = i.$;
        function e() {
            var e = {}
              , t = function i() {
        ...
        return {
            ...
            isIOS: t,
            isMac: function f() {
                return null === c && (c = 0 <= navigator.platform.toUpperCase().indexOf("MAC")),
                c
            },
            isAndroid: n,
            isBlackberry: r,
            ...
            isURL: function y(e) {
                ...
                new RegExp("^".concat(H.LinkRegExHTTP).concat(H.LinkRegExEnd, "$"),"gi").test(e))
            },
            ...
            _init: function S() {
                ...
                function t() {
                    ...
                    h("mousedown", function() {
                        for (var e = 0; e < H.INSTANCES.length; e++)
                            H.INSTANCES[e] !== l && H.INSTANCES[e].popups && H.INSTANCES[e].popups.areVisible() && H.INSTANCES[e].$el.find(".fr-marker").remove()
                    })
                }(),
                function n() {
    ...
    H.MODULES.commands = function(a) {
        ...
        var i = {
            ...
            insertHR: function() {
                ...
                t || void 0 === t || (e = o(e = "".concat(H.MARKERS, "<br>")),
                n.after(e)),
                a.selection.restore()
            },
        ...
        function n(e, t) {
            if (!1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
                var n = H.COMMANDS[e] && H.COMMANDS[e].callback || i[e]
                  , r = !0
                  , o = !1;
                H.COMMANDS[e] && ("undefined" != typeof H.COMMANDS[e].focus && (r = H.COMMANDS[e].focus),
                "undefined" != typeof H.COMMANDS[e].accessibilityFocus && (o = H.COMMANDS[e].accessibilityFocus)),
                (!a.core.hasFocus() && r && !a.popups.areVisible() || !a.core.hasFocus() && o && a.accessibility.hasFocus()) && a.events.focus(!0),
                H.COMMANDS[e] && !1 !== H.COMMANDS[e].undo && (a.$el.find(".fr-marker").length && (a.events.disableBlur(),
                a.selection.restore()),
                a.undo.saveStep()),
                n && n.apply(a, s.merge([e], t || [])),
                a.events.trigger("commands.after", s.merge([e], t || [])),
                H.COMMANDS[e] && !1 !== H.COMMANDS[e].undo && a.undo.saveStep()
            }
        }
        function e(e, t) {
            a.format.toggle(t)
        ...
        return Object.assign(c, {
            ...
            _init: function f() {
                    ...
                    if (t && "HR" === t.tagName)
                        if (e.which === H.KEYCODE.ARROW_LEFT || e.which === H.KEYCODE.ARROW_UP) {
                            if (t.previousSibling)
                                return a.node.isBlock(t.previousSibling) ? a.selection.setAtEnd(t.previousSibling) : s(t).before(H.MARKERS),
                                a.selection.restore(),
                                !1
                        } else if ((e.which === H.KEYCODE.ARROW_RIGHT || e.which === H.KEYCODE.ARROW_DOWN) && t.nextSibling)
                            return a.node.isBlock(t.nextSibling) ? a.selection.setAtStart(t.nextSibling) : s(t).after(H.MARKERS),
                            a.selection.restore(),
                            !1
                }),
                ...
                a.events.on("mouseup", function() {
                    ...
                    e === a.selection.endElement() && e && "HR" === e.tagName && (e.nextSibling && (a.node.isBlock(e.nextSibling) ? a.selection.setAtStart(e.nextSibling) : s(e).after(H.MARKERS)),
                    a.selection.restore())
                })
            }
        })
        ...
        return {
            _startEnter: function E(e) {
                ...
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    s += g.node.closeTagString(l);
                    var c = "";
                    for (c = l.parentNode && "LI" === l.parentNode.tagName ? "".concat(s, "<li>").concat(H.MARKERS, "<br>").concat(a) : i ? "".concat(s, "<").concat(i, ">").concat(H.MARKERS, "<br></").concat(i, ">").concat(a) : "".concat(s + H.MARKERS, "<br>").concat(a); ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName; )
                        l = l.parentNode;
                    ...
                    t = b(n);
                    for (var u = "".concat(H.MARKERS, "<br>"), h = e.parentNode; h && "LI" !== h.tagName; )
                    ...
                    (t = b(n)).parentNode && "LI" === t.parentNode.tagName ? r ? m(t.parentNode).before("".concat(g.node.openTagString(n) + H.MARKERS, "<br></li>")) : m(t.parentNode).after("".concat(g.node.openTagString(n) + H.MARKERS, "<br></li>")) : i ? m(t).before("<".concat(i, ">").concat(H.MARKERS, "<br></").concat(i, ">")) : m(t).before("".concat(H.MARKERS, "<br>")),
                    m(n).remove()
            },
            _middleEnter: function c(e) {
                ...
                n = i + n + o + H.MARKERS + (g.opts.keepFormatOnDelete ? H.INVISIBLE_SPACE : ""),
            ...
            _del: function f(e) {
                ...
                if (r) {
                    ...
                    if (s = s.nextSibling,
                    g.node.isBlock(s))
                        H.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith(H.MARKERS),
                        ...
                        m(e).replaceWith(H.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName; )
                            m(n).append(m(s)),
                            s = s.nextSibling
                }
            }
    ...
    ,
    H.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"],
    H.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"],
    H.MODULES.cursor = function(u) {
        var h = u.$;
        function i(e) {
            ...
            !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
                        0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(H.UNICODE_NBSP,"g"), "").length && (o = r.length - u.opts.tabSpaces + 1);
                    n.textContent = r.substring(0, o - d(r)),
                    u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + H.UNICODE_NBSP);
                    var i = r.length !== n.textContent.length;
                    if (0 === n.textContent.length)
                        if (i && u.opts.keepFormatOnDelete)
                            h(n).after(H.INVISIBLE_SPACE + H.MARKERS);
                            ...
                            h(n.parentNode).after(H.MARKERS),
                            h(n.parentNode).remove();
                    else
                        h(n).after(H.MARKERS)
                } else
                    u.node.isDeletable(n) ? (h(n).after(H.MARKERS),
                    h(n).remove()) : e.nextSibling && "BR" === e.nextSibling.tagName && u.node.isVoid(n) && "BR" !== n.tagName ? (h(e.nextSibling).remove(),
                    h(e).replaceWith(H.MARKERS)) : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).after(H.MARKERS),
                    h(n).remove())
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n))
                if (n.nextSibling) {
                    if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
                        if (!(H.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                    ...
                    if (c(e))
                        ...
                        u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && H.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(),
                        s(e));
                    return
                }
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                for (t = u.node.contents(n); n.nodeType !== Node.TEXT_NODE && t.length && !u.node.isDeletable(n) && u.node.isEditable(n); )
                    n = t[0],
                    t = u.node.contents(n);
                n.nodeType === Node.TEXT_NODE ? (h(n).before(H.MARKERS),
                n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (h(n).before(H.MARKERS),
                h(n).remove()) : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).before(H.MARKERS),
                h(n).remove()),
                h(e).remove()
            } else if (H.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n))
                    ...
                    u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend(H.MARKERS),
                    h(e).remove());
                ...
                t && "BLOCKQUOTE" === n.tagName) {
                    ...
                    h(e).after(h(n).html()).after(H.MARKERS),
                    h(n).remove()
        }
        function p() {
        ...
        function l(e, t, n) {
            ...
            if (o && "BLOCKQUOTE" === o.tagName)
                ...
                t ? h(e).replaceWith("<br>" + H.MARKERS) : r ? h(o).after("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : h(o).after("".concat(H.MARKERS, "<br>")),
                h(e).remove()) : v(e, t, n),
                !1;
            if (null === o)
                (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat(H.MARKERS)) : h(e).replaceWith("<br>".concat(H.MARKERS, "<br>"));
            else {
                var i = e
                  , a = "";
                ...
                } while (i !== o);a = l + a + c + (e.parentNode === o && u.node.isBlock(o) ? "" : H.INVISIBLE_SPACE) + H.MARKERS,
        ...
        function v(e, t, n) {
            ...
            if (null === r)
                u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(H.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"),
                h(e).replaceWith("<br>".concat(H.MARKERS)));
            else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName)
                h(e).replaceWith("<" + u.html.defaultTag() + ">" + H.MARKERS + "<br></" + u.html.defaultTag() + ">");
            else {
                var o = e
                  , i = "";
                "PRE" === r.tagName && (t = !0),
                ...
                if ("BLOCKQUOTE" === r.tagName)
                    ...
                    i = a + i + s + (d ? "" : H.INVISIBLE_SPACE) + H.MARKERS;
        ...
        return {
            enter: function b(e) {
                ...
                for (var n = t.parentNode; n && !u.node.isElement(n); ) {
                    if ("false" === n.getAttribute("contenteditable"))
                        return h(t).replaceWith(H.MARKERS),
                        u.selection.restore(),
                        !1;
                ...
                i(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
                    ...
                    if (o && "BLOCKQUOTE" === o.tagName)
                        if (g(e, o)) {
                            if (!t)
                                return (r = u.html.defaultTag()) ? h(o).before("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : h(o).before("".concat(H.MARKERS, "<br>")),
                                h(e).remove(),
                                !1
                        } else
                            m(e, o) ? l(e, t, !0) : v(e, t, !0);
                    if (null === o)
                        (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(H.MARKERS));
                    else {
                        if (u.node.isBlock(o))
                            if ("PRE" === o.tagName && (t = !0),
                            t)
                                h(e).remove(),
                                h(o).prepend("<br>".concat(H.MARKERS));
                                ...
                                if (u.opts.keepFormatOnDelete) {
                                    for (var i = e, a = H.INVISIBLE_SPACE; i !== o && !u.node.isElement(i); )
                                        i = i.parentNode,
            ...
            backspace: function E() {
                ...
                return i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : e = f(t) : a(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                    for (var t = 0 < h(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" !== n.tagName && n.parentElement !== u.el && !u.node.hasClass(n.parentElement, "fr-inner") && H.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0; )
                        n = n.parentElement;
                    if (n && "BLOCKQUOTE" === n.tagName) {
                                ...
                                if (u.node.isDeletable(a))
                                    ...
                                    if (u.node.isBlock(a))
                                        if (u.node.isEmpty(a) && !u.node.isList(a))
                                            h(a).remove(),
                                            h(e).after(u.opts.keepFormatOnDelete ? H.INVISIBLE_SPACE : "");
                                        else {
    ...
    H.MODULES.data = function(f) {
        ...
        function g() {
            var e = 0;
            if (10 < e && (f[p(A("0ppecjvc=="))](),
            setTimeout(function() {
                E.FE = null
            }, 10)),
            !f.$box)
                return !1;
            f.$wp.prepend(A(p(A(C)))),
        ...
        return {
            _init: function O() {
                ...
                for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                    var l = (r = e[s],
                    4 === (o = (A(r) || "").split("|")).length && "V3" === o[0] ? [o[1], o[3], o[2]] : [null, null, ""])
                      , c = l[2];
                    if (c === A(p(A("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(N, c.length - N.length) || m(N)) {
                        ...
                        new Date(n) < new Date && (S = y,
                        1)) : new Date(n) < new Date(A(T))) || !(0 < (N || "").length) || m(N)) {
                            f.ul = !1;
                            break
                        }
                        i = !0,
                ...
                var d = new Image;
                !0 === f.ul && (g(),
                d.src = i ? "".concat(p(A(t)), "e=").concat(a) : "".concat(p(A(t)), "u")),
    ...
    H.MODULES.format = function(m) {
            ...
            if (e) {
                ...
                if (e) {
                    if (m.node.isBlock(e) && "HR" !== e.tagName)
                        return m.node.hasClass(e.firstChild, "fr-marker") ? b(e.firstChild.nextSibling, t, n) : b(e.firstChild, t, n),
                        !1;
                    ...
                    for (var o = e; o && !v(o).is(".fr-marker") && 0 === v(o).find(".fr-marker").length && "UL" !== o.tagName && "OL" !== o.tagName; ) {
                        var i = o;
                        if (m.node.isBlock(o) && "HR" !== e.tagName)
                            return b(o.firstChild, t, n),
                            !1;
                        o = o.nextSibling,
                        r.append(i)
                    }
                    if (o) {
                        if (v(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName)
                            b(o.firstChild, t, n);
                            ...
                            for (a = 0; a < l; a++)
                                ...
                                (r = v(f(t, n)).insertBefore(o)).append(o))
                        }
                    } else {
                        for (var c = r.get(0).parentNode; c && !c.nextSibling && !m.node.isElement(c); )
                            c = c.parentNode;
                        if (c) {
                            var d = c.nextSibling;
        ...
        function n(e, t) {
            ...
            m.selection.isCollapsed()) {
                m.markers.insert(),
                m.$el.find(".fr-marker").replaceWith(f(e, t) + H.INVISIBLE_SPACE + H.MARKERS + function a(e) {
                    return "</".concat(e, ">")
                }(e)),
                m.selection.restore()
            } else {
                var r;
                m.selection.save(),
                b(m.$el.find('.fr-marker[data-type="true"]').length && m.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
                do {
                    for (r = m.$el.find("".concat(p(e, t), " > ").concat(p(e, t))),
                    n = 0; n < r.length; n++)
                        r[n].outerHTML = r[n].innerHTML
                } while (r.length);m.el.normalize();
        ...
        function E(e, t, n, r) {
            if (!r) {
                var o = !1;
                if (!0 === e.data("type"))
                    for (; m.node.isFirstSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul"); )
                        e.parent().before(e),
                        o = !0;
                else if (!1 === e.data("type"))
                    for (; m.node.isLastSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul"); )
                        e.parent().after(e),
                        o = !0;
                if (o)
                    return !0
            ...
            if (e.parents(t).length || void 0 === t) {
                ...
                if (l.is(m.$el) || m.node.isBlock(l.get(0)))
                    return !1;
                for (; !(m.node.isBlock(l.parent().get(0)) || void 0 !== t && u(l.get(0), p(t, n))); )
                    a += m.node.closeTagString(l.get(0)),
                    s = m.node.openTagString(l.get(0)) + s,
                    l = l.parent();
                var c = e.get(0).outerHTML;
                return e.replaceWith('<span id="mark"></span>'),
                i = l.html().replace(/<span id="mark"><\/span>/, a + m.node.closeTagString(l.get(0)) + s + c + a + m.node.openTagString(l.get(0)) + s),
            ...
            !function d(e, t, n, r) {
                for (var o = m.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                    ...
                    m.node.hasClass(a, "fr-marker"))
                        ...
                        if (0 < v(a).find(".fr-marker").length)
                            t = d(v(a), t, n, r);
                        else {
                        ...
                        0 < v(a).find(".fr-marker").length && (t = d(v(a), t, n, r))
                }
                return t
            }(m.$el, 0, e, t),
            n || (m.$el.find(".fr-marker").remove(),
            m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
            n && m.$el.find(".fr-marker").before(H.INVISIBLE_SPACE).after(H.INVISIBLE_SPACE),
            !m.selection.text() && v(m.selection.blocks()[0]).each(function(e, t) {
        ...
        function t(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                    if (m.node.isEmpty(l.get(0)))
                        s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(H.INVISIBLE_SPACE).concat(H.MARKERS)),
                        l.replaceWith(s);
                    else {
                        var c = {};
                        c["style*"] = "".concat(e, ":"),
                        ...
                        t ? (s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(H.INVISIBLE_SPACE).concat(H.MARKERS)),
                        r.replaceWith(s)) : r.replaceWith(H.INVISIBLE_SPACE + H.MARKERS)
                    }
                    m.html.cleanEmptyTags()
                } else
                    m.node.isEmpty(l.get(0)) && l.is("span") ? (r.replaceWith(H.MARKERS),
                    l.css(e, t)) : (s = v('<span style="'.concat(e, ": ").concat(t, ';">').concat(H.INVISIBLE_SPACE).concat(H.MARKERS, "</span>")),
                    r.replaceWith(s));
                s && S(s, e, t)
            } else {
                if (m.selection.save(),
                null === t || "color" === e && 0 < m.$el.find(".fr-marker").parents("u, a").length) {
                    var d = m.$el.find(".fr-marker");
                    for (n = 0; n < d.length; n++)
                        if (!0 === (r = v(d[n])).data("type") || "true" === r.data("type"))
                            for (; m.node.isFirstSibling(r.get(0)) && !r.parent().is(m.$el) && !m.node.isElement(r.parent().get(0)) && !m.node.isBlock(r.parent().get(0)); )
                                r.parent().before(r);
                        else
                            for (; m.node.isLastSibling(r.get(0)) && !r.parent().is(m.$el) && !m.node.isElement(r.parent().get(0)) && !m.node.isBlock(r.parent().get(0)); )
                                r.parent().after(r)
                }
                for (var f = m.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild; )
                    f = f.firstChild;
                var p = {
                ...
                (t || "").match(/\dem$/) && m.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed"); 0 < m.$el.find("span.fr-unprocessed").length; ) {
                    if ((s = m.$el.find("span.fr-unprocessed").first().removeClass("fr-unprocessed")).parent().get(0).normalize(),
            ...
            !function g() {
                ...
                for (e = 0; e < o.length; e++) {
                    var i = v(o[e])
                      , a = v(o[e]).prev();
                    i.get(0).previousSibling === a.get(0) && m.node.openTagString(i.get(0)) === m.node.openTagString(a.get(0)) && (i.prepend(a.html()),
                    a.remove())
                }
                m.$el.find("span[style] span[style]").each(function() {
                    if (0 <= v(this).attr("style").indexOf("font-size")) {
                        var e = v(this).parents("span[style]");
                        0 <= e.attr("style").indexOf("background-color") && (v(this).attr("style", "".concat(v(this).attr("style"), ";").concat(e.attr("style"))),
        ...
        function S(e, t, n) {
            ...
            for (r = a.length - 1; 0 <= r; r--)
                o = a[r],
                i = t,
                0 === v(o).attr("style").indexOf("".concat(i, ":")) || 0 <= v(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= v(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
            if ((a = a.not(s)).length) {
                for (var l = "", c = "", d = "", f = "", p = e.get(0); p = p.parentNode,
                v(p).addClass("fr-split"),
                l += m.node.closeTagString(p),
                c = m.node.openTagString(v(p).clone().addClass("fr-split").get(0)) + c,
                a.get(0) !== p && (d += m.node.closeTagString(p),
                f = m.node.openTagString(v(p).clone().addClass("fr-split").get(0)) + f),
                a.get(0) !== p; )
                    ;
        ...
        function o(e, t) {
            ...
            for (var o = r; o && o.nodeType === Node.ELEMENT_NODE && !u(o, p(e, t)); )
                o = o.firstChild;
            if (o && o.nodeType === Node.ELEMENT_NODE && u(o, p(e, t)))
                return !0;
            var i = r;
            for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== m.el && !u(i, p(e, t)); )
                i = i.parentNode;
    ...
    H.MODULES.spaces = function(l) {
        function r(e, t) {
            ...
            if (!l.html.isPreformatted(i)) {
                ...
                t || (o = o.replace(new RegExp(H.UNICODE_NBSP,"g"), " "));
                for (var a = "", s = 0; s < o.length; s++)
                    32 != o.charCodeAt(s) || 0 !== s && 32 != a.charCodeAt(s - 1) || n && r && l.node.isVoid(n) || n && r && l.node.isVoid(r) ? a += o[s] : a += H.UNICODE_NBSP;
                (!r || r && l.node.isBlock(r) || r && r.nodeType === Node.ELEMENT_NODE && l.win.getComputedStyle(r) && "block" === l.win.getComputedStyle(r).display) && (l.node.isVoid(n) || (a = a.replace(/ $/, H.UNICODE_NBSP))),
                !n || l.node.isVoid(n) || l.node.isBlock(n) || 1 !== (a = a.replace(/^\u00A0([^ $])/, " $1")).length || 160 !== a.charCodeAt(0) || !r || l.node.isVoid(r) || l.node.isBlock(r) || l.node.hasClass(n, "fr-marker") && l.node.hasClass(r, "fr-marker") || (a = " "),
                t || (a = a.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2")),
                e.textContent !== a && (e.textContent = a)
            }
        }
        function c(e, t) {
            if (void 0 !== e && e || (e = l.el),
            void 0 === t && (t = !1),
        ...
        return {
            ...
            normalizeAroundCursor: function d() {
                for (var e = [], t = l.el.querySelectorAll(".fr-marker"), n = 0; n < t.length; n++) {
                    for (var r = null, o = l.node.blockParent(t[n]), i = (r = o || t[n]).nextSibling, a = r.previousSibling; i && "BR" === i.tagName; )
                        i = i.nextSibling;
                    for (; a && "BR" === a.tagName; )
                        a = a.previousSibling;
    ...
    ,
    H.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">'.concat(H.INVISIBLE_SPACE = "&#8203;", "</span>"),
    H.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">'.concat(H.INVISIBLE_SPACE, "</span>"),
    H.MARKERS = H.START_MARKER + H.END_MARKER,
    H.MODULES.markers = function(d) {
        var f = d.$;
        function l() {
            if (!d.$wp)
                return null;
            ...
            place: function p(e, t, n) {
                ...
                try {
                    ...
                    a.insertNode(function l(e, t) {
                        ...
                        return n.addClass("fr-marker").attr("data-id", t).attr("data-type", e).attr("style", "display: ".concat(d.browser.safari ? "none" : "inline-block", "; line-height: 0;")).html(H.INVISIBLE_SPACE),
                        n.get(0)
                    }(t, n)),
                    !0 === t)
    ...
    H.MODULES.selection = function(y) {
        ...
        function s() {
            var e = "";
            return y.win.getSelection ? e = y.win.getSelection() : y.doc.getSelection ? e = y.doc.getSelection() : y.doc.selection && (e = y.doc.selection.createRange().text),
            e.toString()
        }
        function S() {
        ...
        function d(e) {
            ...
            if (t && t.getRangeAt && t.rangeCount) {
                ...
                n = y.doc.createRange ? [y.doc.createRange()] : [];
            ...
            if (y.$wp) {
                ...
                for (t = 0; t < n.length; t++)
                    if (n[t].startContainer !== y.doc || y.browser.msie) {
                        ...
                        if (void 0 !== i && i || !o || (T(".fr-marker").remove(),
                        y.selection.setAtEnd(y.el)),
                        y.el.normalize(),
                        y.browser.safari && !o)
                            try {
                                (e = y.doc.createRange()).setStartAfter(i),
                                e.setEndBefore(a),
                                r.push(e)
                            } catch (s) {}
                    }
                if (y.browser.safari && r.length)
                    for (y.selection.clear(),
                    t = 0; t < r.length; t++)
                        y.selection.get().addRange(r[t])
            }
        }
        function A() {
            var e, t = y.el.querySelectorAll('.fr-marker[data-type="true"]');
            if (!y.$wp)
                return y.markers.remove(),
                !1;
            if (0 === t.length)
                return !1;
            ...
            y.core.hasFocus() || y.browser.msie || y.browser.webkit || y.$el.focus(),
            C();
            var n = S();
            for (e = 0; e < t.length; e++) {
                var r = T(t[e]).data("id")
                ...
                if (0 < a.length) {
                    ...
                    try {
                        ...
                        if (o.nextSibling === a || a.nextSibling === o) {
                            ...
                            if (g && g.nodeType === Node.TEXT_NODE)
                                for (; g && g.nextSibling && g.nextSibling.nodeType === Node.TEXT_NODE; )
                                    ...
                                    g = g.nextSibling,
                                    T(g.previousSibling).remove();
                            if (h && (y.node.isVoid(h) || y.node.isBlock(h)) && (h = null),
                            g && (y.node.isVoid(g) || y.node.isBlock(g)) && (g = null),
                            h && g && h.nodeType === Node.TEXT_NODE && g.nodeType === Node.TEXT_NODE) {
                                ...
                                T(g).remove(),
                                y.opts.htmlUntouched || y.spaces.normalize(h),
                                i.setStart(h, m),
                                i.setEnd(h, m),
                                l = !0
                            } else
                                !h && g && g.nodeType === Node.TEXT_NODE ? (T(o).remove(),
                                T(a).remove(),
                                y.opts.htmlUntouched || y.spaces.normalize(g),
                                s = T(y.doc.createTextNode("\u200b")).get(0),
                                T(g).before(s),
                                i.setStart(g, 0),
                                i.setEnd(g, 0),
                                l = !0) : !g && h && h.nodeType === Node.TEXT_NODE && (T(o).remove(),
                                T(a).remove(),
                                y.opts.htmlUntouched || y.spaces.normalize(h),
                                s = T(y.doc.createTextNode("\u200b")).get(0),
                                T(h).after(s),
                        ...
                        if (!l) {
                            var v = void 0
                              , b = void 0;
                            b = (y.browser.chrome || y.browser.edge) && o.nextSibling === a ? (v = M(a, i, !0) || i.setStartAfter(a),
                            M(o, i, !1) || i.setEndBefore(o)) : (o.previousSibling === a && (a = (o = a).nextSibling),
                            a.nextSibling && "BR" === a.nextSibling.tagName || !a.nextSibling && y.node.isBlock(o.previousSibling) || o.previousSibling && "BR" === o.previousSibling.tagName || (o.style.display = "inline",
                            a.style.display = "inline",
                            s = T(y.doc.createTextNode("\u200b")).get(0)),
                            v = M(o, i, !0) || T(o).before(s) && i.setStartBefore(o),
                            M(a, i, !1) || T(a).after(s) && i.setEndAfter(a)),
                            "function" == typeof v && v(),
                            "function" == typeof b && b()
                        }
                    } catch (E) {}
        ...
        function M(e, t, n) {
            ...
            T(o).remove(),
            T(e).remove(),
            y.opts.htmlUntouched || y.spaces.normalize(i),
            function() {
                t.setStart(i, r)
            }
            ...
            T(i).remove(),
            T(e).remove(),
            y.opts.htmlUntouched || y.spaces.normalize(o),
            function() {
                t.setEnd(o, r)
            }
            )) : o && !i && o.nodeType === Node.TEXT_NODE ? (r = o.textContent.length,
            n ? (y.opts.htmlUntouched || y.spaces.normalize(o),
            function() {
                t.setStart(o, r)
            }
            ) : (y.opts.htmlUntouched || y.spaces.normalize(o),
            ...
            )) : !(!i || o || i.nodeType !== Node.TEXT_NODE) && (n ? (y.opts.htmlUntouched || y.spaces.normalize(i),
            function() {
                t.setStart(i, 0)
            }
            ) : (y.opts.htmlUntouched || y.spaces.normalize(i),
        ...
        function o(e) {
            ...
            if (y.win.getSelection) {
                ...
                y.doc.selection && "Control" !== y.doc.selection.type && ((n = (t = y.doc.selection.createRange()).duplicate()).moveToElementText(e),
        ...
        function x(e, t) {
            ...
            for (var r = y.node.contents(e), o = 0; o < r.length; o++)
                r[o].nodeType !== Node.ELEMENT_NODE ? T(r[o]).remove() : (x(r[o], 0 === o),
                0 === o && (t = !1));
            if (e.nodeType === Node.TEXT_NODE) {
                var i = T(document.createElement("span")).attr("data-first", "true").attr("data-text", "true");
                T(e)[0].replaceWith(i[0])
            } else
                t && T(e).attr("data-first", !0)
        }
        function w() {
        ...
        function p() {
            try {
                if (!y.$wp)
                    return !1;
                for (var e = d(0).commonAncestorContainer; e && !y.node.isElement(e); )
                    e = e.parentNode;
        ...
        function r(e, t) {
            if (!e || 0 < e.getElementsByClassName("fr-marker").length)
                return !1;
            for (var n = e.firstChild; n && (y.node.isBlock(n) || t && !y.node.isVoid(n) && n.nodeType === Node.ELEMENT_NODE); )
                n = (e = n).firstChild;
        ...
        function i(e, t) {
            if (!e || 0 < e.getElementsByClassName("fr-marker").length)
                return !1;
            for (var n = e.lastChild; n && (y.node.isBlock(n) || t && !y.node.isVoid(n) && n.nodeType === Node.ELEMENT_NODE); )
                n = (e = n).lastChild;
            var r = y.doc.createElement("SPAN");
            for (r.setAttribute("id", "fr-sel-markers"),
            r.innerHTML = H.MARKERS; e.parentNode && y.opts.htmlAllowedEmptyTags && 0 <= y.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase()); )
                e = e.parentNode;
            e.appendChild(r);
        ...
        return {
                ...
                try {
                    if (e.rangeCount) {
                        ...
                        if (r.nodeType === Node.ELEMENT_NODE) {
                            var o = !1;
                            0 < r.childNodes.length && r.childNodes[n.endOffset] && T(r.childNodes[n.endOffset]).text() === s() ? (r = r.childNodes[n.endOffset],
                            ...
                            o = !0),
                            !o && 0 < r.childNodes.length && T(r.childNodes[r.childNodes.length - 1]).text() === s() && ["BR", "IMG", "HR"].indexOf(r.childNodes[r.childNodes.length - 1].tagName) < 0 && (r = r.childNodes[r.childNodes.length - 1])
                        }
            ...
            isFull: function a() {
                ...
                for (e = 0; e < t.length; e++)
                    t[e].nextSibling && (t[e].innerHTML = '<span class="fr-mk">'.concat(H.INVISIBLE_SPACE, "</span>").concat(t[e].innerHTML));
                var n = !1
                  , r = o(y.el);
                for (r.atStart && r.atEnd && (n = !0),
                t = y.el.querySelectorAll(".fr-mk"),
                e = 0; e < t.length; e++)
                    t[e].parentNode.removeChild(t[e]);
                return y.selection.restore(),
                n
            },
            inEditor: p,
            remove: function $() {
                ...
                for (e = 0; e < r.length; e++)
                    for (var o = r[e]; !(t(o) || y.node.isBlock(o.parentNode) || y.$el.is(o.parentNode) || y.node.hasClass(o.parentNode, "fr-inner")); )
                        T(o.parentNode).before(o);
                var i = y.$el.find('.fr-marker[data-type="false"]');
                for (e = 0; e < i.length; e++) {
                    for (var a = i[e]; !(n(a) || y.node.isBlock(a.parentNode) || y.$el.is(a.parentNode) || y.node.hasClass(a.parentNode, "fr-inner")); )
                        T(a.parentNode).after(a);
                ...
                if (function E() {
                    for (var e = y.$el.find(".fr-marker"), t = 0; t < e.length; t++)
                        if (T(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length)
                            return !1;
                    return !0
                }()) {
                    !function S(e, t) {
                        ...
                        for (var r = 0; r < n.length; r++) {
                            var o = n[r];
                            y.node.hasClass(o, "fr-marker") ? t = (t + 1) % 2 : t ? 0 < T(o).find(".fr-marker").length ? t = S(T(o), t) : ["TD", "TH"].indexOf(o.tagName) < 0 && !y.node.hasClass(o, "fr-inner") ? !y.opts.keepFormatOnDelete || 0 < y.$el.find("[data-first]").length || y.node.isVoid(o) ? T(o).remove() : x(o) : y.node.hasClass(o, "fr-inner") ? 0 === T(o).find(".fr-inner").length ? T(o).html("<br>") : T(o).find(".fr-inner").filter(w).html("<br>") : (T(o).empty(),
                            T(o).attr("data-del-cell", !0)) : 0 < T(o).find(".fr-marker").length && (t = S(T(o), t))
                        }
                        return t
                    }(y.$el, 0);
                    var s = y.$el.find('[data-first="true"]');
                    if (s.length)
                        y.$el.find(".fr-marker").remove(),
                        s.append(H.INVISIBLE_SPACE + H.MARKERS).removeAttr("data-first"),
                        ...
                        y.$el.find("[data-del-cell]").removeAttr("data-del-cell"),
                        r = y.$el.find('.fr-marker[data-type="true"]'),
                        e = 0; e < r.length; e++) {
                            var l = r[e]
                              , c = l.nextSibling
                            ...
                            if (d) {
                                if (l && (!c || c !== d)) {
                                    ...
                                    f !== p)
                                        if (null !== f || u)
                                            if (null !== p || h || 0 !== T(f).parentsUntil(y.$el, "table").length)
                                                f && p && 0 === T(f).parentsUntil(y.$el, "table").length && 0 === T(p).parentsUntil(y.$el, "table").length && !T(f).contains(p) && !T(p).contains(f) && (T(f).append(T(p).html()),
                                                T(p).remove());
                                            else {
                                                for (c = f; !c.nextSibling && c.parentNode !== y.el; )
                                                    c = c.parentNode;
                                            ...
                                            m ? (T(m).after(T(p).html()),
                                            T(p).remove()) : 0 === T(p).parentsUntil(y.$el, "table").length && (T(l).next().after(T(p).html()),
                                            T(p).remove())
                                        }
                                }
                            } else
                                d = T(l).clone().attr("data-type", !1),
                                T(l).after(d)
                        }
                }
                y.$el.find("li:empty").remove(),
                y.opts.keepFormatOnDelete || y.html.fillEmptyBlocks(),
                y.html.cleanEmptyTags(!0),
                y.opts.htmlUntouched || (y.clean.lists(),
                y.$el.find("li:empty").append("<br>"),
                y.spaces.normalize());
                var v = y.$el.find(".fr-marker").last().get(0)
                  , b = y.$el.find(".fr-marker").first().get(0);
                void 0 !== v && void 0 !== b && !v.nextSibling && b.previousSibling && "BR" === b.previousSibling.tagName && y.node.isElement(v.parentNode) && y.node.isElement(b.parentNode) && y.$el.append("<br>"),
                A()
            },
            blocks: function u() {
                var e, t, n = [], r = S();
                if (p() && r.rangeCount) {
                    ...
                    for (e = 0; e < o.length; e++) {
                        ...
                        (y.node.isBlock(a) || y.node.hasClass(a, "fr-inner")) && n.indexOf(a) < 0 && n.push(a),
                        (t = y.node.blockParent(a)) && n.indexOf(t) < 0 && n.push(t);
                        for (var l = [], c = a; c !== s && c !== y.el; )
                            ...
                            l.push(c)),
                            y.node.isBlock(c) && l.indexOf(c) < 0 && n.indexOf(c) < 0 && (c !== s || 0 < i.endOffset) && n.push(c);
                        y.node.isBlock(s) && n.indexOf(s) < 0 && 0 < i.endOffset && n.push(s),
                        (t = y.node.blockParent(s)) && n.indexOf(t) < 0 && n.push(t)
                    }
                }
                for (e = n.length - 1; 0 < e; e--)
                    T(n[e]).find(n).length && n.splice(e, 1);
                return n
            },
            info: o,
            setAtEnd: i,
            ...
            setBefore: function h(e, t) {
                ...
                for (var n = e.previousSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length; )
                    n = n.previousSibling;
                return n ? (y.node.isBlock(n) ? i(n) : "BR" === n.tagName ? T(n).before(H.MARKERS) : T(n).after(H.MARKERS),
                !0) : !!t && (y.node.isBlock(e) ? r(e) : T(e).before(H.MARKERS),
                !0)
            },
            setAfter: function g(e, t) {
                ...
                for (var n = e.nextSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length; )
                    n = n.nextSibling;
                return n ? (y.node.isBlock(n) ? r(n) : T(n).before(H.MARKERS),
                !0) : !!t && (y.node.isBlock(e) ? i(e) : T(e).after(H.MARKERS),
                !0)
            },
            rangeElement: f
        }
    ...
    H.LANGUAGE = {},
    H.MODULES.language = function(e) {
        var t;
        return {
            _init: function n() {
                H.LANGUAGE && (t = H.LANGUAGE[e.opts.language]),
    ...
    H.MODULES.placeholder = function(f) {
        ...
        function e() {
            ...
            var e, t = 0, n = 0, r = 0, o = 0, i = 0, a = 0, s = 0, l = f.node.contents(f.el), c = p(f.selection.element()).css("text-align");
            l.length && l[0].nodeType === Node.ELEMENT_NODE ? (e = p(l[0]),
            (0 < f.$wp.prev().length || 0 < f.$el.prev().length) && f.ready && (t = f.helpers.getPX(e.css("margin-top")),
            ...
            f.$placeholder.css("line-height", e.css("line-height"))) : (f.$placeholder.css("font-size", f.$el.css("font-size")),
            f.$placeholder.css("line-height", f.$el.css("line-height"))),
            f.$wp.addClass("show-placeholder"),
            f.$placeholder.css({
                marginTop: t - (e && e.length ? e[0].parentNode.offsetHeight : 0),
    ...
    ,
    H.UNICODE_NBSP = String.fromCharCode(160),
    H.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"],
    H.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"],
    Object.assign(H.DEFAULTS, {
    ...
    H.MODULES.html = function($) {
            ...
            if (e) {
                ...
                for (t = 0; t < o.length; t++) {
                    ...
                    if (i) {
                        var a = i.nextSibling
                          , s = i.previousSibling;
                        i && r.indexOf(i) < 0 && $.node.isBlock(i) && r.push(i),
                        s && $.node.isBlock(s) && r.indexOf(s) < 0 && r.push(s),
                        a && $.node.isBlock(a) && r.indexOf(a) < 0 && r.push(a)
                    }
                }
            } else
                r = $.el.querySelectorAll(u());
            var l = u();
            for (l += ",".concat(H.VOID_ELEMENTS.join(",")),
            l += ", .fr-inner",
            l += ",".concat($.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"),
            t = r.length - 1; 0 <= t; t--)
        ...
        function e(e) {
            ...
            r = p.merge(r, $.opts.htmlAllowedEmptyTags),
            r = void 0 === e ? p.merge(r, H.BLOCK_TAGS) : p.merge(r, H.NO_DELETE_TAGS),
        ...
        function a(e, t) {
            ...
            n) {
                for (var r = $.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1; a; ) {
                    var l = a.nextSibling;
                    if (a.nodeType === Node.ELEMENT_NODE && ($.node.isBlock(a) || 0 <= $.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) && !$.node.hasClass(a, "fr-marker")))
                        o = null,
                        ...
                        null === o ? (o = $.doc.createElement(n),
                        s = !0,
                        t && (o.setAttribute("class", "fr-temp-div"),
                        o.setAttribute("data-empty", !0)),
                        o.appendChild(a.cloneNode(!0)),
                        r.appendChild(o)) : !1 === i && (o.appendChild($.doc.createElement("br")),
                        t && (o.setAttribute("class", "fr-temp-div"),
                        o.setAttribute("data-empty", !0))),
                        o = null;
                    else {
                        var c = a.textContent;
                        a.nodeType !== Node.TEXT_NODE || 0 < c.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || c.replace(/(^ *)|( *$)/g, "").length && c.indexOf("\n") < 0 ? (null === o && (o = $.doc.createElement(n),
                        s = !0,
                        t && o.setAttribute("class", "fr-temp-div"),
                        r.appendChild(o),
                        i = !1),
                        o.appendChild(a.cloneNode(!0)),
                        i || $.node.hasClass(a, "fr-marker") || a.nodeType === Node.TEXT_NODE && 0 === c.replace(/ /g, "").length || (i = !0)) : s = !0
                    }
                    a = l
                }
                s && (e.innerHTML = "",
        ...
        function t(e, t, n, r, o) {
            ...
            var i = $.$wp.scrollTop();
            a($.el, e),
            r && l($.el.querySelectorAll(".fr-inner"), e),
            t && l($.el.querySelectorAll("td, th"), e),
            n && l($.el.querySelectorAll("blockquote"), e),
            o && l($.el.querySelectorAll("li"), e),
            i !== $.$wp.scrollTop() && $.$wp.scrollTop(i)
        }
        function n(e) {
            if (void 0 === e && (e = $.el),
                ...
                if (!s(n.parentNode, !0)) {
                    ...
                    if (r) {
                        var i = n.previousSibling
                          , a = n.nextSibling;
                        i && a && " " === o ? o = $.node.isBlock(i) && $.node.isBlock(a) ? "" : " " : (i || (o = o.replace(/^ */, "")),
                        a || (o = o.replace(/ *$/, "")))
                    }
                    n.textContent = o
                }
        ...
        function c(e) {
            ...
            if (t && ($.node.isBlock(t) || $.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                ...
                !t || $.node.isBlock(t) || $.node.isElement(t) || e.previousSibling || e.nextSibling || !$.node.isDeletable(e.parentNode) || c(e.parentNode)
        }
        function h() {
            $.opts.htmlUntouched || (e(),
            t(),
            n(),
            $.spaces.normalize(null, !0),
        ...
        function o() {
            $.node.isEmpty($.el) && (null !== d() ? $.el.querySelector(u()) || $.el.querySelector("".concat($.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || ($.core.hasFocus() ? ($.$el.html("<".concat(d(), ">").concat(H.MARKERS, "<br/></").concat(d(), ">")),
            $.selection.restore()) : $.$el.html("<".concat(d(), "><br/></").concat(d(), ">"))) : $.el.querySelector("*:not(.fr-marker):not(br)") || ($.core.hasFocus() ? ($.$el.html("".concat(H.MARKERS, "<br/>")),
            $.selection.restore()) : $.$el.html("<br/>")))
        }
        function g(e, t) {
        ...
        function k(e) {
            if ($.events.trigger("html.processGet", [e]),
        ...
        function E(e) {
            var t = null;
            if (void 0 === e && (t = $.selection.element()),
            $.opts.keepFormatOnDelete)
                return !1;
            var n, r, o = t ? (t.textContent.match(/\u200B/g) || []).length - t.querySelectorAll(".fr-marker").length : 0;
            if (($.el.textContent.match(/\u200B/g) || []).length - $.el.querySelectorAll(".fr-marker").length === o)
                return !1;
            do {
                r = !1,
                n = $.el.querySelectorAll("*:not(.fr-marker)");
        ...
        function S() {
            E(),
            $.placeholder && setTimeout($.placeholder.refresh, 0)
        }
        return {
            defaultTag: d,
            isPreformatted: s,
            ...
            set: function N(e) {
                ...
                if ($.opts.fullPage) {
                    ...
                    var l = v(t)
                      , c = m(t, "html");
                    b($.$el, "".concat(s, "\n").concat(n)),
                    $.node.clearAttributes($.el),
                    $.$el.attr(r),
                    $.$el.addClass("fr-view"),
                    $.$el.attr("spellcheck", $.opts.spellcheck),
                    $.$el.attr("dir", $.opts.direction),
                    b($.$head, o),
                    $.node.clearAttributes($.$head.get(0)),
                    $.$head.attr(i),
                    $.node.clearAttributes($.$html.get(0)),
                    $.$html.attr(c),
                    $.iframe_document.doctype.parentNode.replaceChild(function f(e, t) {
                ...
                $.edit.on(),
                $.core.injectStyle($.opts.iframeDefaultStyle + $.opts.iframeStyle),
                h(),
                $.opts.useClasses || ($.$el.find("[fr-original-class]").each(function() {
                ...
                d && $.edit.off(),
                $.events.trigger("html.set")
            },
            get: function _(e, t) {
                if (!$.$wp)
                    return $.$oel.clone().removeClass("fr-view").removeAttr("contenteditable").get(0).outerHTML;
                var n = "";
                ...
                if (!$.opts.useClasses && !t) {
                    ...
                    for (r = 0; r < $.doc.styleSheets.length; r++) {
                        var d = void 0
                          , f = 0;
                        try {
                            d = $.doc.styleSheets[r].cssRules,
                            $.doc.styleSheets[r].ownerNode && "STYLE" === $.doc.styleSheets[r].ownerNode.nodeType && (f = 1)
                        } catch (w) {}
                        if (d)
                            for (var p = 0, u = d.length; p < u; p++)
                                if (d[p].selectorText && 0 < d[p].style.cssText.length) {
                                    ...
                                    for (o = 0; o < g.length; o++) {
                                        !g[o].getAttribute("fr-original-style") && g[o].getAttribute("style") ? (g[o].setAttribute("fr-original-style", g[o].getAttribute("style")),
                                        i.push(g[o])) : g[o].getAttribute("fr-original-style") || (g[o].setAttribute("fr-original-style", ""),
                                        i.push(g[o])),
                                        a[g[o]] || (a[g[o]] = {});
                                        for (var m = 1e3 * f + D(d[p].selectorText), v = d[p].style.cssText.split(";"), b = 0; b < v.length; b++) {
                                            var E = v[b].trim().split(":")[0];
                                            if (E && !E.match(c) && (a[g[o]][E] || (a[g[o]][E] = 0) <= (g[o].getAttribute("fr-original-style") || "").indexOf("".concat(E, ":")) && (a[g[o]][E] = 1e4),
                                            m >= a[g[o]][E] && (a[g[o]][E] = m,
                                            v[b].trim().length))) {
                                                var S = v[b].trim().split(":");
                                                S.splice(0, 1),
                                                s.push([g[o], E.trim(), S.join(":").trim(), m])
                                            }
                                        }
                                    }
                                }
                            ...
                            for (o = 0; o < T.length; o++)
                                if (0 < T[o].indexOf(":")) {
                                    var C = T[o].split(":")
                                      , N = C[0];
                                    C.splice(0, 1),
                                    i[r].style[N.trim()] = C.join(":").trim()
                                }
                        }
                }
                if ($.node.isEmpty($.el))
                    $.opts.fullPage && (n = L($.iframe_document),
                    n += "<html".concat($.node.attributes($.$html.get(0)), ">").concat($.$html.find("head").get(0).outerHTML, "<body></body></html>"));
                else if (void 0 === e && (e = !1),
                $.opts.fullPage) {
                    n = L($.iframe_document),
                    $.$el.removeClass("fr-view");
                    ...
                    $.opts.heightMax = null,
                    $.size.refresh(),
                    n += "<html".concat($.node.attributes($.$html.get(0)), ">").concat($.$html.html(), "</html>"),
                    $.opts.heightMin = A,
                    $.opts.height = M,
                    $.opts.heightMax = O,
                    $.size.refresh(),
                ...
                $.opts.htmlSimpleAmpersand && (n = n.replace(/&amp;/gi, "&")),
                $.events.trigger("html.afterGet"),
                e || (n = n.replace(/<span[^>]*? class\s*=\s*["']?fr-marker["']?[^>]+>\u200b<\/span>/gi, "")),
                n = $.clean.invisibleSpaces(n),
                n = $.clean.exec(n, k);
            ...
            getSelected: function A() {
                function e(e, t) {
                    for (; t && (t.nodeType === Node.TEXT_NODE || !$.node.isBlock(t)) && !$.node.isElement(t) && !$.node.hasClass(t, "fr-inner"); )
                        t && t.nodeType !== Node.TEXT_NODE && p(e).wrapInner($.node.openTagString(t) + $.node.closeTagString(t)),
                        t = t.parentNode;
                ...
                if ("undefined" != typeof $.win.getSelection) {
                    $.browser.mozilla && ($.selection.save(),
                    1 < $.$el.find('.fr-marker[data-type="false"]').length && ($.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(),
                    $.$el.find('.fr-marker[data-type="false"]:last').attr("data-id", "0"),
                    $.$el.find(".fr-marker").not('[data-id="0"]').remove()),
                    $.selection.restore());
                    for (var o = $.selection.ranges(), i = 0; i < o.length; i++) {
                        ...
                        e(a, (n = t = void 0,
                        n = null,
                        $.win.getSelection ? (t = $.win.getSelection()) && t.rangeCount && (n = t.getRangeAt(0).commonAncestorContainer).nodeType !== Node.ELEMENT_NODE && (n = n.parentNode) : (t = $.doc.selection) && "Control" !== t.type && (n = t.createRange().parentElement()),
                        null !== n && (0 <= p(n).parents().toArray().indexOf($.el) || n === $.el) ? n : null)),
                        0 < p(a).find(".fr-element").length && (a = $.el),
                        r += a.innerHTML
                    }
                } else
                    "undefined" != typeof $.doc.selection && "Text" === $.doc.selection.type && (r = $.doc.selection.createRange().htmlText);
                return r
            },
            insert: function M(e, t, n) {
                var r;
                if ($.selection.isCollapsed() || $.selection.remove(),
                r = t ? e : $.clean.html(e),
                e.indexOf('class="fr-marker"') < 0 && (r = function a(e) {
                    var t = $.doc.createElement("div");
                    return t.innerHTML = e,
                    $.selection.setAtEnd(t, !0),
                    t.innerHTML
                }(r)),
                $.node.isEmpty($.el) && !$.opts.keepFormatOnDelete && f(r))
                    $.el.innerHTML = r;
                else {
                        ...
                        if ((f(r) || n) && ($.node.deepestParent(o) || i && "LI" === i.tagName)) {
                            if (i && "LI" === i.tagName && (r = function s(e) {
                                ...
                                for (var n = t.querySelectorAll(":scope > ".concat($.html.defaultTag())), r = n.length - 1; 0 <= r; r--) {
                                    var o = n[r];
                                    $.node.isBlock(o.previousSibling) || (o.previousSibling && !$.node.isEmpty(o) && p("<br>").insertAfter(o.previousSibling),
                                    o.outerHTML = o.innerHTML)
                                }
                                return t.innerHTML
                            }(r)),
                ...
                h(),
                $.keys.positionCaret(),
                $.events.trigger("html.inserted")
            },
            wrap: t,
            unwrap: function O() {
                $.$el.find("div.fr-temp-div").each(function() {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && p(this).before("<br>"),
                    p(this).attr("data-empty") || !this.nextSibling || $.node.isBlock(this.nextSibling) && !p(this.nextSibling).hasClass("fr-temp-div") ? p(this).replaceWith(p(this).html()) : p(this).replaceWith("".concat(p(this).html(), "<br>"))
                }),
            ...
            extractDoctype: v,
            cleanBRs: function w() {
                for (var e = $.el.getElementsByTagName("br"), t = 0; t < e.length; t++)
                    c(e[t])
            },
            _init: function R() {
                $.$wp && ($.events.on("mouseup", S),
                $.events.on("keydown", S),
                $.events.on("contentChanged", o))
            }
        }
    }
    ,
    ...
    H.MODULES.keys = function(p) {
        ...
        function e() {
            if (p.browser.mozilla && p.selection.isCollapsed() && !h) {
                var e = p.selection.ranges(0)
                  , t = e.startContainer
                  , n = e.startOffset;
                t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 32 === t.textContent.charCodeAt(n - 1) && (p.selection.save(),
                p.spaces.normalize(),
                p.selection.restore())
            }
        }
        function o() {
            p.selection.isFull() && setTimeout(function() {
                ...
                e ? p.$el.html("<".concat(e, ">").concat(H.MARKERS, "<br/></").concat(e, ">")) : p.$el.html("".concat(H.MARKERS, "<br/>")),
                p.selection.restore(),
        ...
        function s(e) {
            ...
            if (16 === n)
                return !0;
            if ((u = n) === H.KEYCODE.IME)
                return h = !0;
            h = !1;
            var r = b(n) && !m(e) && !e.altKey
              , o = n === H.KEYCODE.BACKSPACE || n === H.KEYCODE.DELETE;
            if ((p.selection.isFull() && !p.opts.keepFormatOnDelete && !p.placeholder.isVisible() || o && p.placeholder.isVisible() && p.opts.keepFormatOnDelete) && (r || o) && (g(),
            !b(n)))
                return e.preventDefault(),
                !0;
            n === H.KEYCODE.ENTER ? e.shiftKey ? function i(e) {
                e.preventDefault(),
                e.stopPropagation(),
                p.opts.multiLine && (p.selection.isCollapsed() || p.selection.remove(),
                p.cursor.enter(!0))
            }(e) : function a(e) {
                p.opts.multiLine ? (p.helpers.isIOS() || (e.preventDefault(),
                e.stopPropagation()),
                p.selection.isCollapsed() || p.selection.remove(),
                p.cursor.enter()) : (e.preventDefault(),
                e.stopPropagation())
                ...
                if (!p.helpers.isMobile() && t && "A" === t.tagName) {
                    ...
                    if (n) {
                        ...
                        !n.nextSibling && n.parentNode && "A" === n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;".concat(H.MARKERS)),
                ...
                if (0 < p.opts.tabSpaces)
                    if (p.selection.isCollapsed()) {
                        ...
                        e.preventDefault(),
                        e.stopPropagation();
                        for (var t = "", n = 0; n < p.opts.tabSpaces; n++)
                            t += "&nbsp;";
                        p.html.insert(t),
                        p.placeholder.refresh(),
                        p.undo.saveStep()
                        ...
                        e.preventDefault(),
                        e.stopPropagation(),
                        e.shiftKey ? p.commands.outdent() : p.commands.indent()
            }(e) : m(e) || !b(e.which) || p.selection.isCollapsed() || e.ctrlKey || e.altKey || p.selection.remove() : p.placeholder.isVisible() ? (p.opts.keepFormatOnDelete || g(),
            e.preventDefault(),
            e.stopPropagation()) : function d(e) {
                e.preventDefault(),
                e.stopPropagation(),
                "" === p.selection.text() && "IMG" != p.selection.element().tagName ? p.cursor.del() : p.selection.remove(),
                p.placeholder.refresh()
            }(e) : p.placeholder.isVisible() ? (p.opts.keepFormatOnDelete || g(),
            e.preventDefault(),
            e.stopPropagation()) : function f(e) {
                if (p.selection.isCollapsed())
                    if (p.cursor.backspace(),
                    p.helpers.isIOS()) {
                        var t = p.selection.ranges(0);
                        t.deleteContents(),
                        t.insertNode(document.createTextNode("\u200b")),
                        p.selection.get().modify("move", "forward", "character")
                    } else
                        e.preventDefault(),
                        e.stopPropagation();
                else
        ...
        function l() {
            if (!p.$wp)
                return !0;
            var e;
            p.opts.height || p.opts.heightMax ? (e = p.position.getBoundingRect().top,
            (p.helpers.isIOS() || p.helpers.isAndroid()) && (e -= p.helpers.scrollTop()),
            p.opts.iframe && (e += p.$iframe.offset().top),
            e > p.$wp.offset().top - p.helpers.scrollTop() + p.$wp.height() - 20 && p.$wp.scrollTop(e + p.$wp.scrollTop() - (p.$wp.height() + p.$wp.offset().top) + p.helpers.scrollTop() + 20)) : (e = p.position.getBoundingRect().top,
            p.opts.toolbarBottom && (e += p.opts.toolbarStickyOffset),
            (p.helpers.isIOS() || p.helpers.isAndroid()) && (e -= p.helpers.scrollTop()),
            p.opts.iframe && (e += p.$iframe.offset().top,
            e -= p.helpers.scrollTop()),
            (e += p.opts.toolbarStickyOffset) > p.o_win.innerHeight - 20 && t(p.o_win).scrollTop(e + p.helpers.scrollTop() - p.o_win.innerHeight + 20),
            e = p.position.getBoundingRect().top,
            p.opts.toolbarBottom || (e -= p.opts.toolbarStickyOffset),
            (p.helpers.isIOS() || p.helpers.isAndroid()) && (e -= p.helpers.scrollTop()),
            p.opts.iframe && (e += p.$iframe.offset().top,
            e -= p.helpers.scrollTop()),
            e < 100 && t(p.o_win).scrollTop(e + p.helpers.scrollTop() - 100))
        }
        function c(e) {
            var t = p.selection.element();
            if (t && 0 <= ["INPUT", "TEXTAREA"].indexOf(t.tagName))
                return !0;
            if (e && 0 === e.which && u && (e.which = u),
            p.helpers.isAndroid() && p.browser.mozilla)
                return !0;
            if (h)
                return !1;
            if (e && p.helpers.isIOS() && e.which === H.KEYCODE.ENTER && p.doc.execCommand("undo"),
            !p.selection.isCollapsed())
                return !0;
            if (e && (e.which === H.KEYCODE.META || e.which === H.KEYCODE.CTRL))
                return !0;
            if (e && v(e.which))
                return !0;
            if (e && !p.helpers.isIOS() && (e.which === H.KEYCODE.ENTER || e.which === H.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !p.browser.msie))
                try {
                    l()
                } catch (r) {}
        ...
        function v(e) {
            if (e >= H.KEYCODE.ARROW_LEFT && e <= H.KEYCODE.ARROW_DOWN)
                return !0
        }
        function b(e) {
            if (e >= H.KEYCODE.ZERO && e <= H.KEYCODE.NINE)
                return !0;
            if (e >= H.KEYCODE.NUM_ZERO && e <= H.KEYCODE.NUM_MULTIPLY)
                return !0;
            if (e >= H.KEYCODE.A && e <= H.KEYCODE.Z)
                return !0;
            if (p.browser.webkit && 0 === e)
                return !0;
            switch (e) {
        ...
        function d(e) {
            var t = e.which;
            if (m(e) || 37 <= t && t <= 40 || !b(t) && t !== H.KEYCODE.DELETE && t !== H.KEYCODE.BACKSPACE && t !== H.KEYCODE.ENTER && t !== H.KEYCODE.IME)
                return !0;
            n || (r = p.snapshot.get(),
        ...
        function f(e) {
            ...
            if (m(e) || 37 <= t && t <= 40)
                return !0;
            r && n ? (p.undo.saveStep(r),
            r = null) : void 0 !== t && 0 !== t || r || n || p.undo.saveStep()
        }
        function E(e) {
            if (e && "BR" === e.tagName)
                return !1;
        ...
        function S(e) {
            ...
            !p.node.isEditable(e.target) || r && "false" === r.getAttribute("contenteditable") ? p.toolbar.disable() : p.toolbar.enable(),
            !(!e.target || e.target === p.el) || (0 === t.length || void (t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? E(t[t.length - 1]) && (n ? p.$el.append("<".concat(n, ">").concat(H.MARKERS, "<br></").concat(n, ">")) : p.$el.append("".concat(H.MARKERS, "<br>")),
            p.selection.restore(),
            l()) : e.offsetY <= 10 && E(t[0]) && (n ? p.$el.prepend("<".concat(n, ">").concat(H.MARKERS, "<br></").concat(n, ">")) : p.$el.prepend("".concat(H.MARKERS, "<br>")),
            p.selection.restore(),
            l())))
        }
        function y() {
        ...
        return {
            _init: function T() {
                ...
                p.events.on("input", e),
                p.events.on("mousedown", a),
                p.events.on("keyup input", f),
                p.events.on("keypress", i),
                p.events.on("keydown", s),
                p.events.on("keyup", c),
                p.events.on("destroy", y),
                p.events.on("html.inserted", c),
                p.events.on("cut", o),
                p.opts.multiLine && p.events.on("click", S)
            },
            ctrlKey: m,
            isCharacter: b,
            isArrow: v,
            ...
            e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                "" !== a) {
                    ...
                    !1 !== o) {
                        ...
                        return x(i).replaceWith(H.MARKERS),
                        M.selection.restore(),
                        c(),
                        e.preventDefault && (e.stopPropagation(),
                        e.preventDefault()),
        ...
        function o(e, t, n) {
            ...
            "" !== e) {
                ...
                if (M.opts.enter === H.ENTER_BR)
                    ...
                    M.opts.enter === H.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
                e = f.innerHTML,
                l && (e = function N(e) {
    ...
    H.SHORTCUTS_MAP = {},
    H.RegisterShortcut = function(e, t, n, r, o, i) {
    ...
    ,
    H.RegisterShortcut(H.KEYCODE.E, "show", null, "E", !1, !1),
    H.RegisterShortcut(H.KEYCODE.B, "bold", null, "B", !1, !1),
    H.RegisterShortcut(H.KEYCODE.I, "italic", null, "I", !1, !1),
    H.RegisterShortcut(H.KEYCODE.U, "underline", null, "U", !1, !1),
    H.RegisterShortcut(H.KEYCODE.S, "strikeThrough", null, "S", !1, !1),
    H.RegisterShortcut(H.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1),
    H.RegisterShortcut(H.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1),
    H.RegisterShortcut(H.KEYCODE.Z, "undo", null, "Z", !1, !1),
    H.RegisterShortcut(H.KEYCODE.Z, "redo", null, "Z", !0, !1),
    H.RegisterShortcut(H.KEYCODE.Y, "redo", null, "Y", !1, !1),
    H.MODULES.shortcuts = function(s) {
        var r = null;
        var l = !1;
        function e(e) {
            if (!s.core.hasFocus())
            ...
            if ("keyup" === e.type && l && t !== H.KEYCODE.META)
                return l = !1;
            "keydown" === e.type && (l = !1);
            ...
            n && H.SHORTCUTS_MAP[r] && (!o || "false" !== o.getAttribute("contenteditable"))) {
                ...
                if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
                    ...
                    if (!1 === s.events.trigger("shortcut", [e, i, a]))
                        return !(l = !0);
                    if (i && (s.commands[i] || H.COMMANDS[i] && H.COMMANDS[i].callback))
                        return e.preventDefault(),
                        e.stopPropagation(),
                        "keydown" === e.type && ((s.commands[i] || H.COMMANDS[i].callback)(),
                        l = !0),
                        !1
                }
            }
        ...
        return {
            ...
            get: function o(e) {
                ...
                if (!r)
                    for (var t in r = {},
                    H.SHORTCUTS_MAP)
                        Object.prototype.hasOwnProperty.call(H.SHORTCUTS_MAP, t) && 0 <= s.opts.shortcutsEnabled.indexOf(H.SHORTCUTS_MAP[t].cmd) && (r["".concat(H.SHORTCUTS_MAP[t].cmd, ".").concat(H.SHORTCUTS_MAP[t].val || "")] = {
    ...
    H.MODULES.undo = function(n) {
        function e(e) {
            var t = e.which;
            n.keys.ctrlKey(e) && (t === H.KEYCODE.Z && e.shiftKey && e.preventDefault(),
            t === H.KEYCODE.Z && e.preventDefault())
        }
        var t = null;
        function r() {
    ...
    H.MODULES.popups = function(f) {
        ...
        function l(e, t) {
            ...
            1 < f.opts.zIndex && (f.opts.editInPopup ? o.css("z-index", f.opts.zIndex + 2) : f.$tb.css("z-index", f.opts.zIndex + 2)),
    ...
    H.MODULES.accessibility = function(f) {
        ...
        function e(e) {
            ...
            if (e.which !== H.KEYCODE.F10 || t || e.shiftKey || !e.altKey)
                return !0;
            f.shared.with_kb = !0;
        ...
        return {
            _init: function r() {
                ...
                f.events.on("mousedown", function(e) {
                    T(f),
                    f.shared.$f_el && (f.accessibility.restoreSelection(),
                    e.stopPropagation(),
                    f.events.disableBlur(),
                    f.shared.$f_el = null)
                }, !0),
                    ...
                    return {
                        _tiKeydown: function(e) {
                            ...
                            if (H.KEYCODE.TAB === n) {
                                ...
                                if (H.KEYCODE.ENTER !== n || !e.target || "TEXTAREA" === e.target.tagName)
                                    return H.KEYCODE.ESC === n ? (e.preventDefault(),
                                    e.stopPropagation(),
                                    ...
                                    y(d)),
                                    !1) : H.KEYCODE.SPACE === n && (r.is(".fr-submit") || r.is(".fr-dismiss")) ? (e.preventDefault(),
                                    e.stopPropagation(),
                                    t.events.disableBlur(),
                                    t.button.exec(r),
                                    !0) : t.keys.isBrowserAction(e) ? void e.stopPropagation() : r.is("input[type=text], textarea") ? void e.stopPropagation() : H.KEYCODE.SPACE === n && (r.is(".fr-link-attr") || r.is("input[type=file]")) ? void e.stopPropagation() : (e.stopPropagation(),
                                    e.preventDefault(),
                                    !1);
                                var l = null;
    ...
    ,
    H.TOOLBAR_VISIBLE_BUTTONS = 3,
    H.MODULES.button = function(g) {
        var h = g.$
          , a = [];
        ...
        function o(e) {
            ...
            if (!n) {
                ...
                H.COMMANDS[l] && H.COMMANDS[l].refreshOnShow && H.COMMANDS[l].refreshOnShow.apply(o, [e, t]),
        ...
        function t(e) {
            ...
            t.popups.areVisible() && !t.popups.areVisible(t)) {
                for (var n = 0; n < H.INSTANCES.length; n++)
                    H.INSTANCES[n] !== t && H.INSTANCES[n].popups && H.INSTANCES[n].popups.areVisible() && H.INSTANCES[n].$el.find(".fr-marker").remove();
                t.popups.hideAll()
            }
            g.node.hasClass(e.get(0), "fr-dropdown") ? o(e) : (!function r(e) {
                i(e)
            }(e),
            H.COMMANDS[e.data("cmd")] && !1 !== H.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh())
        }
        function c(e) {
            t(h(e.currentTarget))
        }
        ...
        function e(o) {
            ...
            setTimeout(function() {
                for (var e = i.selection.inEditor() && i.core.hasFocus(), t = 0; t < o.length; t++) {
                    var n = h(o[t])
                      , r = n.data("cmd");
                    0 === n.parents(".fr-popup").length ? e || H.COMMANDS[r] && H.COMMANDS[r].forcedRefresh ? i.button.refresh(n) : g.node.hasClass(n.get(0), "fr-dropdown") || (n.removeClass("fr-active"),
        ...
        return {
            ...
            refresh: function C(e) {
                ...
                H.COMMANDS[r] && H.COMMANDS[r].refresh ? H.COMMANDS[r].refresh.apply(n, [e, t]) : g.refresh[r] && n.refresh[r](e, t)
            },
            bulkRefresh: n,
            exec: i,
            click: t,
        ...
        return {
            create: function i(n) {
                ...
                if (void 0 !== r) {
                    ...
                    "svg" !== t || r.PATH || (r.PATH = H.SVG[r.SVG_KEY] || ""),
                    t && (t = H.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function(e, t) {
            ...
            create: function d(n, e, t) {
                ...
                !c[n]) {
                    ...
                    l.events.$on(r, "keydown", function(e) {
                        var t = e.which;
                        return t === H.KEYCODE.ESC ? (s(n),
                        l.accessibility.focusModalButton(r),
                        !1) : !(!a(e.currentTarget).is("input[type=text], textarea") && t !== H.KEYCODE.ARROW_UP && t !== H.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(),
                        e.stopPropagation(),
                        1))
                    }, !0),
                    s(n, !0)
    ...
    H.MODULES.position = function(S) {
        ...
        function t(e) {
            ...
            if (S.core.hasFocus() || 0 < S.$tb.findVisible("input:focus").length) {
                ...
                clearTimeout(y(e).css("sticky-timeout")),
                n.css("top", "0"),
                n.css("position", ""),
                n.css("width", ""),
                n.data("sticky-top", 0),
        ...
        return {
            _init: function s() {
                !function e() {
                    S._stickyElements = [],
                    S.helpers.isIOS() ? (r(),
                    S.events.$on(y(S.o_win), "scroll", function() {
                        if (S.core.hasFocus())
                            for (var e = 0; e < S._stickyElements.length; e++) {
                    ...
                    }, !0)) : ("body" !== S.opts.scrollableContainer && S.events.$on(y(S.opts.scrollableContainer), "scroll", a, !0),
                    S.events.$on(y(S.o_win), "scroll", a, !0),
                    S.events.$on(y(S.o_win), "resize", a, !0),
                    S.events.on("initialized", a),
                    S.events.on("focus", a),
                    S.events.$on(y(S.o_win), "resize", "textarea", a, !0)),
    ...
    H.TOOLBAR_BUTTONS_MD = null,
    (H.TOOLBAR_BUTTONS_SM = {}).moreText = Object.assign({}, H.TOOLBAR_BUTTONS.moreText, {
        buttonsVisible: 2
    }),
    ...
    H.MODULES.toolbar = function(m) {
        ...
        t[H.XS] = e(m.opts.toolbarButtonsXS || m.opts.toolbarButtons || H.TOOLBAR_BUTTONS_XS || H.TOOLBAR_BUTTONS || []),
        t[H.SM] = e(m.opts.toolbarButtonsSM || m.opts.toolbarButtons || H.TOOLBAR_BUTTONS_SM || H.TOOLBAR_BUTTONS || []),
        t[H.MD] = e(m.opts.toolbarButtonsMD || m.opts.toolbarButtons || H.TOOLBAR_BUTTONS_MD || H.TOOLBAR_BUTTONS || []),
        t[H.LG] = e(m.opts.toolbarButtons || H.TOOLBAR_BUTTONS || []);
        var i = null;
        function a(e) {
            clearTimeout(i),
            e && e.which === H.KEYCODE.ESC || (i = setTimeout(n, m.opts.typingTimer))
        }
        function s() {
        ...
        return {
            _init: function p() {
                ...
                (!1 !== m.ul || m.opts.attribution) && m.$second_tb.prepend(H.POWERED_BY)),
        ...
        wrapInner: function(e) {
            if ("string" == typeof e) {
                for (var t = e.split(" "), n = 0; n < t.length && 0 === t[n].trim().length; )
                    n++;
                if (n < t.length && (t[n].trim() === v(e)[0].tagName && (e = document.createElement(t[n].trim())),
                n++),
                "string" != typeof e)
    ...
    E.Bootstrap.prototype.destroy = function() {
        ...
        this.core && e && this.core.destroy(e),
