...
$(document).on('submit', '#formUpdateClub', function (e) {
    e.preventDefault();
    ...
    if(clubId == null || clubObjective == null || clubSpec == null || clubResource == null || clubAssessment == null || clubName == "" || clubClass == "" || clubAmount == "" || clubPlace == "" || clubSubject == "" || clubTeacher == "" || clubDescription == "" || clubPlan == null || userCode == null || userCode == ""){
      Swal.fire({
        title: 'Error!',
      ...
      $.ajax({
        url: burl() + 'api/backdoor/club/update',
        method: 'POST',
        headers: {
